        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(this.$user.login(request));

            case 7:
              res = _context.sent;
              _context.next = 10;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(this.$user.storeSession(res.data));
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 6;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(this.$user.signup(request));
                          ...
                          _c(
                            ...
                            [
                              _c(
                                ...
                                [_vm._v("Belum Punya Akun? Daftar Disini")]
                              ),
                              _vm._v(" "),
                              _c("v-spacer"),
                              _vm._v(" "),
                          ...
                          _c(
                            ...
                            [
                              _c(
                                "router-link",
                                { attrs: { to: { path: "/login" } } },
                                [_vm._v("Sudah Memiliki Akun? Login Disini")]
                              ),
                              _vm._v(" "),
                              _c("v-spacer"),
                              _vm._v(" "),
